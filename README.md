...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/momentum-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/momentum-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add momentum momentum-cpp pymomentum pymomentum-core pymomentum-cpu pymomentum-gpu
# for installing globally
pixi global install momentum momentum-cpp pymomentum pymomentum-core pymomentum-cpu pymomentum-gpu
```
...
It is possible to list all of the versions of `momentum` available on your platform:
...
```
pixi search momentum --channel conda-forge
```
